...
import { ringgAlternativePageData as data } from '@/data/best-ringg-ai-alternative-data';
...
const PAGE_SECTIONS = [
  ...
  { id: 'ringg-features', label: 'Ringg AI' },
...
function PageNav() {
  return (
    <nav
      ...
      className="sticky top-16 z-30 border-b border-gray-200/80 bg-white/90 backdrop-blur-md"
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
          ...
          >
            ...
            <ExpandableBlock summary="Why teams switch from Ringg AI">
...
function WhatIsRinggSection() {
  const { whatIsRingg } = data;
  ...
  return (
    <section id="overview" className="relative overflow-hidden bg-white py-16 sm:py-20">
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeader badge={whatIsRingg.badge} title={whatIsRingg.title} subtitle={whatIsRingg.summary} />

        <div className="mt-12 grid gap-8 lg:grid-cols-5">
          <div className="grid grid-cols-2 gap-3 lg:col-span-2">
            {whatIsRingg.stats.map((stat) => (
              <div
                key={stat.label}
          ...
          <div className="lg:col-span-3">
            <div className="rounded-2xl border border-gray-100 bg-slate-50/50 p-6">
              ...
              <ul className="space-y-3">
                {whatIsRingg.highlights.map((item, i) => (
              ...
              <div className="mt-5">
                <ExpandableBlock summary="Read full platform overview">
                  <div className="space-y-4">
                    {whatIsRingg.paragraphs.map((p, i) => (
                      <p key={i}>{p}</p>
                    ))}
                  </div>
                </ExpandableBlock>
...
function RinggFeaturesSection() {
  const { ringgFeatures } = data;

  return (
    <section id="ringg-features" className="bg-gradient-to-br from-slate-50 via-white to-blue-50/30 py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeader
          badge={ringgFeatures.badge}
          title={ringgFeatures.title}
          subtitle={ringgFeatures.subtitle}
        />
        <div className="mt-10 divide-y divide-gray-100 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
          {ringgFeatures.features.map((feature, index) => {
    ...
    <section id="pain-points" className="bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <SectionHeader
          ...
          subtitle="Five patterns that push buyers toward Ringg AI alternatives in 2026."
        />
          ...
          {whyLookForAlternative.reasons.map((reason, index) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                className="flex gap-4 rounded-2xl border border-red-100/80 bg-gradient-to-br from-red-50/30 to-white p-5 sm:p-6"
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-1 text-sm font-medium text-red-800/90">{reason.summary}</p>
...
function ComparisonSection() {
  ...
  const ondialWins = comparison.rows.filter(
    (r) => r.ondial === 'yes' && (r.ringg === 'no' || r.ringg === 'partial' || r.ringg === 'not-stated')
  ).length;
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 hidden overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg md:block">
          <div className="grid grid-cols-3 border-b border-gray-200 bg-slate-50 text-sm font-semibold text-gray-700">
            ...
            <div className="border-l border-gray-200 px-6 py-4">Ringg AI</div>
          </div>
          {comparison.rows.map((row, index) => (
            ...
            >
              ...
              <div className="border-l border-gray-100 px-6 py-4">
                <ComparisonCell status={row.ringg} note={row.ringgNote} />
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 flex justify-center gap-2">
          {['compare', 'all'].map((v) => (
            ...
            >
              {v === 'compare' ? 'vs Ringg AI' : 'All industries'}
            </button>
          ))}
        </div>
...
function SwitchBenefitsSection() {
